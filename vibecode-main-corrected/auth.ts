      ...
      if (!existingUser) {
        const newUser = await db.user.create({
          data: {
            ...
            name: user.name,
            image: user.image,
            // Stocker automatiquement le token GitHub si l'utilisateur se connecte avec GitHub
            githubToken: account.provider === 'github' ? account.access_token : null,
        ...
        // Mettre à jour le token GitHub si l'utilisateur se connecte avec GitHub
