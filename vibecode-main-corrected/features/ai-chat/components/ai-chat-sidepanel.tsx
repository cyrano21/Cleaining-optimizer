...
export const AIChatSidePanel: React.FC<AIChatSidePanelProps> = ({
  ...
  const addFileAttachment = (
    ...
    console.log('📎 addFileAttachment called in AIChatSidePanel:', fileName, content.length, 'characters');
    const language = detectLanguage(fileName, content);
    const type = detectFileType(fileName);
    console.log('Detected language:', language, 'type:', type);
    if (type !== "code") {
      console.log('❌ File rejected - not a code file:', type);
      return; // Only allow code files
    }
    ...
    console.log('✅ New file attachment created:', newFile);
    setAttachments((prev) => {
      ...
      <>
        ...
        >
            ...
            <div className="p-6 space-y-6">
              {filteredMessages.length === 0 && !isLoading && (
                <div className="text-center text-zinc-500 py-16">
                  ...
                  <p className="text-zinc-400 max-w-md mx-auto leading-relaxed mb-6">
                    Chat with AI, get code suggestions, and manage your development workflow.
                  </p>
                        ...
                        <ReactMarkdown
                          ...
                          components={{
                            code: (props: React.ComponentProps<"code"> & { inline?: boolean }) => {
                              const { children, className, inline: _inline, ...rest } = props;
                              return (
                                <EnhancedCodeBlock
                                  className={className}
              ...
              <div className="flex-1 relative">
                ...
                <div className="absolute right-3 bottom-3 flex items-center gap-2">
                  <Button
                    ...
                    size="sm"
                    onClick={() => {
                      console.log('🔗 Attach button clicked in AIChatSidePanel');
          ...
          <input
            ...
            onChange={(e) => {
              console.log('📁 File input onChange triggered in AIChatSidePanel');
              ...
              files.forEach((file) => {
                ...
                reader.onload = (event) => {
                  const content = event.target?.result as string;
                  console.log('File content loaded:', file.name, content.length, 'characters');
                  addFileAttachment(file.name, content, file.type);
                };
                reader.readAsText(file);
              });
