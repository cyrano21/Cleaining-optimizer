...
export default function UtilitiesParamètresPage() {
  const {
    settings,
    loading,
    updateSettings,
    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              Configure system Paramètres and preferences
            </p>
          </div>
        </div>
        ...
        <RecentOrderSettings
          ...
          onSave={() => handleSave("recentOrder")}          loading={loading}
        />
        ...
        <GeneralInfoSettings
          ...
          onSave={() => handleSave("generalInfo")}          loading={loading}
        />
        ...
        <AdminAppearanceSettings
          ...
          onSave={() => handleSave("adminAppearance")}          loading={loading}
        />
        ...
        <CacheSettings
          ...
          onSave={() => handleSave("cache")}          loading={loading}
        />
        ...
        <DatabaseSettings
          ...
          onSave={() => handleSave("database")}          loading={loading}
        />
        ...
        <OptimizeSettings
          ...
          onSave={() => handleSave("optimizePageSpeed")}          loading={loading}
        />
        ...
        <ThemeSettings
          ...
          onSave={() => handleSave("theme")}          loading={loading}
        />
        ...
        <ContactAndAnalyticsSettings
          ...
          onSaveAnalytics={() => handleSave("googleAnalytics")}          loading={loading}
        />
        ...
        <AdditionalSettings
          ...
          onSaveSlider={() => handleSave("simpleSliders")}          loading={loading}
        />
      </div>
    </DashboardLayout>
  );
