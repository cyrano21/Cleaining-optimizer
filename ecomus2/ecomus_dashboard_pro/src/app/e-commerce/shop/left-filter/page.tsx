...
import FilterSidebar, { ActiveFilters } from '@/components/ui/FilterSidebar';
...
const transformFilterOptions = (options: typeof realFilterOptions) => ({
...
export default function ShopLeftFilterPage() {
     ...
     <DashboardLayout>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Boutique - Filtres à Gauche</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex gap-8">
          {/* Sidebar de filtres - Toujours à gauche */}
                ...
                `}>
                  {paginatedProducts.map((product) => (
                    <ProductCard
                      key={product.id}
                      product={product}
                      onAddToWishlist={() => handleProductAction(product.id, 'favorite')}
