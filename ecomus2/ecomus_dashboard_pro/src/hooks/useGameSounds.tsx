...
// Composant pour contrôler les paramètres audio
export function GameAudioSettings({ 
  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border">
      <h3 className="font-semibold mb-3">🔊 Effets Sonores</h3>
      
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <label htmlFor="game-sounds-enabled" className="text-sm">Activer les sons</label>
          <input
            id="game-sounds-enabled"
            type="checkbox"
            checked={enabled}
        ...
        {enabled && (
          <div className="flex items-center gap-2">
            <label htmlFor="game-sounds-volume" className="text-sm">Volume</label>
            <input
              id="game-sounds-volume"
              type="range"
              min="0"
              max="1"
              step="0.1"
