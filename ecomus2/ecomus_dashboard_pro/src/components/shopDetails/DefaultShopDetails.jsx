...
export default function DefaultShopDetails({ product }) {
  ...
  const [activeView, setActiveView] = useState('images'); // 'images' or '3d'
          ...
          <div className="row">
            <div className="col-md-6">
              <div className="tf-product-media-wrap sticky-top">
                {/* Basculeur d'affichage 2D/3D */}
                <div className="tf-view-toggle mb-3">
                  <div className="btn-group w-100" role="group">
                    <button
                      type="button"
                      className={`btn ${activeView === 'images' ? 'btn-primary' : 'btn-outline-primary'}`}
                      onClick={() => setActiveView('images')}
                    >
                      <i className="icon-gallery"></i> Images
                    </button>
                    {product.models3D && product.models3D.length > 0 && (
                      <button
                        type="button"
                        className={`btn ${activeView === '3d' ? 'btn-primary' : 'btn-outline-primary'}`}
                        onClick={() => setActiveView('3d')}
                      >
                        <i className="icon-3d-rotate"></i> Vue 3D
                      </button>
                    )}
                  </div>
                </div>
 ...
 style={{ width: "100%", height: "auto" }}                         />
                  ...
                  {/* Section IA Generator */}
                  <div className="tf-product-info-ai-section mt-4">
                    <div className="ai-section-header">
                      <h6 className="fw-6 mb-3">
                        <i className="icon-magic-wand"></i> Fonctionnalités IA
                      </h6>
                    </div>
                    <AIGenerator 
                      productContext={{
