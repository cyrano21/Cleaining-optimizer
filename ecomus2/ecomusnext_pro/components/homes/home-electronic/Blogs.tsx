...
export default function Blogs({ title = '', limit = 3, layout = 'default' }: { title?: string; limit?: number; layout?: string } = {}) {
  return (
    <section className="flat-spacing-14">
      <div className="container">
        <div className="flat-title wow fadeInUp" data-wow-delay="0s">
          <span className="title">{title || "Blogs post"}</span>
        </div>
