...
export default function Testimonials({ title, limit, layout }) {
  return (
    <section className="flat-spacing-18 flat-testimonial bg_grey-7">
      <div className="container">
        <div className="flat-title wow fadeInUp" data-wow-delay="0s">
          <span className="title">{title || "Happy Clients"}</span>
        ...
        <div className="wrap-carousel">
          <Swiper
            ...
            spaceBetween={30}
            breakpoints={{
              1024: { slidesPerView: limit || 3, spaceBetween: 30 },
              768: { slidesPerView: limit || 3, spaceBetween: 30 },
