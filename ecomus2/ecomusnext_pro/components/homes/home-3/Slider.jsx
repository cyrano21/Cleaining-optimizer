...
const sliderData = [
  {
    ...
    title: "Fashion\nTrends",
    text: "Stay ahead with our latest collection",
    btnText: "Discover",
  },
  {
    id: 2,
    ...
    title: "Premium\nQuality",
    text: "Experience luxury fashion",
    btnText: "Shop Premium",
  },
];
  ...
  return (
    <div className="tf-slideshow slider-effect-fade position-relative">
      <Swiper
        ...
        pagination={{ clickable: true, el: ".sp3" }}
        navigation={{
          prevEl: ".snbp3",
          nextEl: ".snbn3",
        }}
      ...
      <div className="wrap-pagination">
        <div className="container">
          <div className="sw-dots sp3 sw-pagination-slider justify-content-center" />
        </div>
      </div>
      <div className="nav-sw nav-next-slider snbp3 nav-next-collection">
        <span className="icon icon-arrow-left" />
      </div>
      <div className="nav-sw nav-prev-slider snbn3 nav-prev-collection">
